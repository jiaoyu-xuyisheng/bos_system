				...
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>
							...
							<select id="noassociationSelect" multiple="multiple" size="10" style="min-width:60px;">
						...
						<td>
							<select id="associationSelect" name="customerIds" multiple="multiple" size="10" style="min-width:60px;">
