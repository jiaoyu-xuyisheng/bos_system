            ...
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
               <form  id="editPasswordForm">
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input id="txtNewPass" type="Password"  name="password" 
                         class="txt01 easyui-validatebox" data-options="validType:'length[6,12]'"></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
...
<script>
	$("#btnEp").click(function(){
		...
		if(v){
			var psd=$("#txtNewPass").val();
			$.post("userAction_editPassword.action",{"password":psd},function(data){
				if(data=='1'){
					$("#editPwdWindow").window("close");
					$.message.alert("提示信息","密码修改成功！！","info")
				}else{
					$.messager.alert("提示信息","密码修改不正确！！","error")
				}
			},"json")
		}else{
